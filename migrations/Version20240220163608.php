 ...
 */
final class Version20240220163608 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE genre_musical_album (genre_musical_id INT NOT NULL, album_id INT NOT NULL, INDEX IDX_1A75836BFFFD05DC (genre_musical_id), INDEX IDX_1A75836B1137ABCF (album_id), PRIMARY KEY(genre_musical_id, album_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
